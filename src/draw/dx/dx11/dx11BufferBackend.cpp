...
namespace hax {
	...
	namespace draw {
		...
		namespace dx11 {
			...
			BufferBackend::BufferBackend() : _pDevice{}, _pContext{}, _pVertexBuffer{}, _pIndexBuffer{}, _capacity{} {}
			...
			void BufferBackend::initialize(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) {
