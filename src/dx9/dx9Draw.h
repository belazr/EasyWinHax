...
namespace dx9 {
	...
	// Parameters:
	// [in] bot:	Screen coordinates of the middle of the bottom side.
	// [in] top:	Screen coordinates of the middle of the top side.
	// [in] ratio:	Ratio of bottom/top side length to height of the parallelogram
	...
	// Draws a 2D box grid.
	// Parameters:
	// [in] bot:	Screen coordinates of the bottom left and right corner of the box.
	// [in] top:	Screen coordinates of the top left and right corner of the box.
	// [in] width:	Line width in pixels.
	// [in] color:	Line color
	...
	// Draws a 3D box grid.
	// Parameters:
	// [in] bot:	Screen coordinates of the four bottom corners of the box.
	// [in] top:	Screen coordinates of the four corners of the box.
	// [in] width:	Line width in pixels.
	// [in] color:	Line color.
	...
	// Parameters:
	// [in] pos1:	Screen coordinates of the beginning of the line.
	// [in] pos2:	Screen coordinates of the end of the line.
	// [in] width:	Width in pixels.
	// [in] color:	Color of the line.
	// Return:		HRESULT of the device method call or E_FAIL if pos1 and pos2 have the same y coordinates.
	...
	// [in] width:	Width in pixels.
	// [in] color:	Color of the line.
	// Return:		HRESULT of the device method call.
	HRESULT drawPrimitiveLine(const Vector2* pos1, const Vector2* pos2, float width, D3DCOLOR color);

	// Draws a set of points.
	// Parameters:
	// [in] origin:	Origin of the set of points to be drawn.
	// [in] points:	Coordinates of the points as offsets to origin.
	// [in] count:	Number of points to be drawn.
	// [in] color:	Color of the points.
	// Return:		HRESULT of the device method call.
