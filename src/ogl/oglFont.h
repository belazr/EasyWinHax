...
namespace gl {
	...
	public:
		...
		// Parameters:
		// [in] pos:	Coordinates of the bottom left corner of the first character of the text.
		// [in] color:	Color of the text.
		// [in] format:	Text to be drawn. Can contain printf style format specifiers.
		// [in] ...:	Additional arguments that replace the format specifiers in format (see printf documentation).
		...
		// [in] textWidth:	Width of the text.
		// [in] textHeight:	Height of the text.
		// Return:			Coordinates of the bottom left corner of the first character of the centered text.
		...
		// Parameters:
		// [in] x:			X coordinate of the left end of the line.
		// [in] width:		Width of the line.
		// [in] textWidth:	Width of the text.
		// Return:			Coordinates of the bottom left corner of the first character of the centered text.
