...
namespace proc {
	...
	namespace ex {
		...
		// Parameters:
		// [in] procName:	Name of the process.
		// Return:			Process id of the process, 0 on failure or no process was found.
		...
		// Parameters:
		// [in] procName:		Name of the process.
		// [out] pProcEntry:	Address of the process entry structure that receives the information about the process.
		//						If there are multiple proccesses with the same name the structure of one of them is returned.
		// Return:				True on success, false on failure or no process was found.
		...
		// Parameters:
		// [in] hProc:			Handle to the process which modules should be searched.
		//						Needs at least PROCESS_QUERY_LIMITED_INFORMATION access rights.
		// [in] modName:		Name of the module.
		// [out] pModEntry:		Address of the module entry structure of the module that receives the information about the module.
		//						If there are multiple modules with the same name the structure of one of them is returned.
		// Return:				True on success, false on failure or no module was found.
		...
		// [in] hMod:			Handle to the module that exports the function.
		// [in] funcName:		Export name of the exported function. Has to be exported by name.
		// Return:				Address of the exported function within the virtual address space of the target process or nullptr on failure or if procedure not found.
		...
		// [in] hImportMod:		Handle to the module that imports the function.
		// [in] exportModName:	Name of the module that exports the imported function.
		// [in] funcName:		Export name of the imported procedure. Has to be exported by name.
		// Return:				Address of the IAT entry within the virtual address space of the target process or nullptr on failure or if IAT entry was not found.
		...
		// [in] hProc:			Handle to the target process.
		//						Needs at least PROCESS_VM_READ and PROCESS_VM_WRITE access rights.
		// [in] hMod:			Handle to the module.
		// [in] pPeHeaders:		Address of the pe headers structure that receives the addresses of the pe headers.
		...
		// Parameters:
		// [in] procId:		The process id of the target process.
		// [in] modName:	The name of the module.
		// Return:			Handle to the module or nullptr on failure or if the module was not found.
		...
		//					Needs at least PROCESS_QUERY_LIMITED_INFORMATION and PROCESS_VM_READ access rights.
		// [in] modName:	The name of the module.
		// Return:			Address of the loader data table entry of the module or nullptr on failure or if the entry was not found.
		...
		// [in] hProc:	Handle to the target process.
		//				Needs at least PROCESS_QUERY_LIMITED_INFORMATION access rights.
		// Return:		Address of the x64 process environment block or nullptr on failure.
		...
		// [in] hProc:	Handle to the target process.
		//				Needs at least PROCESS_QUERY_LIMITED_INFORMATION access rights.
		// Return:		Address of the x86 process environment block or nullptr on failure or if the process is not x86 (not running in the WOW64 environment).
	...
	namespace in {
		...
		// [in] hMod:			Handle to the module that exports the function.
		// [in] funcName:		Export name of the exported function. Has to be exported by name.
		// Return:				Address of the exported function within the virtual address space of the caller process or nullptr on failure or if procedure not found.
		...
		// [in] hImportMod:		Handle to the module that imports the function.
		// [in] exportModName:	Name of the module that exports the imported function.
		// [in] funcName:		Export name of the imported function. Has to be exported by name.
		// Return:				Address of the IAT entry or nullptr on failure or if IAT entry was not found.
		...
		// Parameters:
		// [in] hMod:			Handle to the module or the base address of a pe header in a local buffer.
		// [in] pPeHeaders:		Address of the pe headers structure that receives the addresses of the pe headers.
		//						For architecure specific headers the matching specific addresses are set as well as the general ones with the same value.
		...
		// Parameters:
		// [in] modName:	The name of the module.
		// Return:			Handle to the module or nullptr if the module was not found.
		...
		// Parameters:
		// [in] modName:	The name of the module.
		// Return:			Address of the loader data table entry of the module or nullptr if the entry was not found.
		...
		// Return:	Address of the process environment block. Gets the address of the PEB within the WOW64 evironment for x86 processes.
		PEB* getPebAddress();
